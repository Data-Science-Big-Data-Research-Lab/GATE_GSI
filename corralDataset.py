...
print("Base circuit image saved as 'circuitsQSVM/circuit_base_corral.png'.")
...
results_df.to_csv('resultsCorralQSVM.csv')
print("\nResults saved to 'resultsCorralQSVM.csv'.")
...
print("Best accuracy circuit image saved as 'circuitsQSVM/circuit_best_accuracy_corral.png'.")
...
if not candidates_time.empty:
    ...
    print("Best time circuit image saved as 'circuitsQSVM/circuit_best_time_corral.png'.")
else:
...
best_balanced_circuit.draw('mpl', filename='circuitsQSVM/circuit_best_ranking_corral.png')
print("Best ranking circuit image saved as 'circuitsQSVM/circuit_best_ranking_corral.png'.")
