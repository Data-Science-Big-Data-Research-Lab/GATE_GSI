...
time_map = {'AM': 0, 'PM': 1}
category_map = {'Strength': 1, 'HIIT': 2, 'Cycling': 3, 'Aqua': 4}
...
print(f"Number of unique target labels: {df['attended'].nunique()}")
...
qc.decompose().draw('mpl', filename='circuitsQSVM/circuit_base_fitness.png')
print("Base circuit image saved as 'circuitsQSVM/circuit_base_fitness.png'.")
...
results_df.to_csv('resultsFitnessQSVM.csv')
print("\nResults saved to 'resultsFitnessQSVM.csv'.")
...
best_accuracy_circuit.draw('mpl', filename='circuitsQSVM/circuit_best_accuracy_fitness.png')
print("Best accuracy circuit image saved as 'circuitsQSVM/circuit_best_accuracy_fitness.png'.")
...
if not candidates_time.empty:
    ...
    best_time_circuit.draw('mpl', filename='circuitsQSVM/circuit_best_time_fitness.png')
    print("Best time circuit image saved as 'circuitsQSVM/circuit_best_time_fitness.png'.")
else:
...
best_balanced_circuit.draw('mpl', filename='circuitsQSVM/circuit_best_ranking_fitness.png')
print("Best ranking circuit image saved as 'circuitsQSVM/circuit_best_ranking_fitness.png'.")
