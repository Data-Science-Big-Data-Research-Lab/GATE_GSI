...
print(f"Number of unique target labels: {df['diabetes'].nunique()}")
...
qc.decompose().draw('mpl', filename='circuitsQSVM/circuit_base_diabetes.png')
print("Base circuit image saved as 'circuitsQSVM/circuit_base_diabetes.png'.")
...
results_df.to_csv('resultsDiabetesQSVM.csv')
print("\nResults saved to 'resultsDiabetesQSVM.csv'.")
...
best_accuracy_circuit.draw('mpl', filename='circuitsQSVM/circuit_best_accuracy_diabetes.png')
print("Best accuracy circuit image saved as 'circuitsQSVM/circuit_best_accuracy_diabetes.png'.")
...
if not candidates_time.empty:
    ...
    best_time_circuit.draw('mpl', filename='circuitsQSVM/circuit_best_time_diabetes.png')
    print("Best time circuit image saved as 'circuitsQSVM/circuit_best_time_diabetes.png'.")
else:
...
best_balanced_circuit.draw('mpl', filename='circuitsQSVM/circuit_best_ranking_diabetes.png')
print("Best ranking circuit image saved as 'circuitsQSVM/circuit_best_ranking_diabetes.png'.")
