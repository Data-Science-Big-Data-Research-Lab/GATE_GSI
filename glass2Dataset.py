...
qc.decompose().draw('mpl', filename='circuitsQSVM/circuit_base_glass2.png')
print("Base circuit image saved as 'circuitsQSVM/circuit_base_glass2.png'.")
...
results_df.to_csv('resultsGlass2QSVM.csv')
print("\nResults saved to 'resultsGlass2QSVM.csv'.")
...
best_accuracy_circuit.draw('mpl', filename='circuitsQSVM/circuit_best_accuracy_glass2.png')
print("Best accuracy circuit image saved as 'circuitsQSVM/circuit_best_accuracy_glass2.png'.")
...
if not candidates_time.empty:
    ...
    best_time_circuit.draw('mpl', filename='circuitsQSVM/circuit_best_time_glass2.png')
    print("Best time circuit image saved as 'circuitsQSVM/circuit_best_time_glass2.png'.")
else:
...
best_balanced_circuit.draw('mpl', filename='circuitsQSVM/circuit_best_ranking_glass2.png')
print("Best ranking circuit image saved as 'circuitsQSVM/circuit_best_ranking_glass2.png'.")
