...
qc.decompose().draw('mpl', filename='./circuitsQSVM/circuit_base_Flare_FreeNoiseSimulator.pdf')
...
results_df.to_csv('resultsFlare.csv')
...
best_accuracy_circuit.draw('mpl', filename='./circuitsQSVM/circuit_best_accuracy_Flare_FreeNoiseSimulator.pdf')
...
if not candidates_time.empty:
    ...
    best_time_circuit.draw('mpl', filename='./circuitsQSVM/circuit_best_time_Flare_FreeNoiseSimulator.pdf')
else:
...
best_ranking_circuit.draw('mpl', filename='./circuitsQSVM/circuit_best_ranking_Flare_FreeNoiseSimulator.pdf')
