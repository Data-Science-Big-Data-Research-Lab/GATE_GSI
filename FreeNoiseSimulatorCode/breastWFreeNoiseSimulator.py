...
qc.decompose().draw('mpl', filename='./circuitsQSVM/circuit_base_BreastW_FreeNoiseSimulator.pdf')
...
best_accuracy_circuit.draw('mpl', filename='./circuitsQSVM/circuit_best_accuracy_BreastW_FreeNoiseSimulator.pdf')
...
if not candidates_time.empty:
    ...
    best_time_circuit.draw('mpl', filename='./circuitsQSVM/circuit_best_time_BreastW_FreeNoiseSimulator.pdf')
else:
...
best_ranking_circuit.draw('mpl', filename='./circuitsQSVM/circuit_best_ranking_BreastW_FreeNoiseSimulator.pdf')
