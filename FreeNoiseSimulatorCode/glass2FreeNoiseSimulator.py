...
qc.decompose().draw('mpl', filename='./circuitsQSVM/circuit_base_Glass2_FreeNoiseSimulator.pdf')
...
results_df.to_csv('resultsGlass2.csv')
...
best_accuracy_circuit.draw('mpl', filename='./circuitsQSVM/circuit_best_accuracy_Glass2_FreeNoiseSimulator.pdf')
...
if not candidates_time.empty:
    ...
    best_time_circuit.draw('mpl', filename='./circuitsQSVM/circuit_best_time_Glass2_FreeNoiseSimulator.pdf')
else:
...
best_ranking_circuit.draw('mpl', filename='./circuitsQSVM/circuit_best_ranking_Glass2_FreeNoiseSimulator.pdf')
