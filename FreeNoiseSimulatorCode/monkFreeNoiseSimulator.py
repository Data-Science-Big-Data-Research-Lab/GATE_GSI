...
qc.decompose().draw('mpl', filename='./circuitsQSVM/circuit_base_Monk_FreeNoiseSimulator.pdf')
...
results_df.to_csv('resultsMonk.csv')
...
best_accuracy_circuit.draw('mpl', filename='./circuitsQSVM/circuit_best_accuracy_Monk_FreeNoiseSimulator.pdf')
...
if not candidates_time.empty:
    ...
    best_time_circuit.draw('mpl', filename='./circuitsQSVM/circuit_best_time_Monk_FreeNoiseSimulator.pdf')
else:
...
best_ranking_circuit.draw('mpl', filename='./circuitsQSVM/circuit_best_ranking_Monk_FreeNoiseSimulator.pdf')
