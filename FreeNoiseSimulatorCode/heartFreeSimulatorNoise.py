...
import pandas as pd
from GSI import calculate_GSI_DM, create_feature_map, remove_low_M_gates, pegasusQSVCTrain, pegasusQSVCTest
import numpy as np
...
qc.decompose().draw('mpl', filename='./circuitsQSVM/circuit_base_Heart_FreeNoiseSimulator.pdf')
...
results_df.to_csv('resultsHeart.csv')
...
best_accuracy_circuit.draw('mpl', filename='./circuitsQSVM/circuit_best_accuracy_Heart_FreeNoiseSimulator.pdf')
...
if not candidates_time.empty:
    ...
    best_time_circuit.draw('mpl', filename='./circuitsQSVM/circuit_best_time_Heart_FreeNoiseSimulator.pdf')
else:
...
best_ranking_circuit.draw('mpl', filename='./circuitsQSVM/circuit_best_ranking_Heart_FreeNoiseSimulator.pdf')
