...
qc.decompose().draw('mpl', filename='./circuitsQSVM/circuit_base_Diabetes_NoiseSimulator.pdf')
...
best_accuracy_circuit.draw('mpl', filename='./circuitsQSVM/circuit_best_accuracy_Diabetes_NoiseSimulator.pdf')
...
if not candidates_time.empty:
    ...
    best_time_circuit.draw('mpl', filename='./circuitsQSVM/circuit_best_time_Diabetes_NoiseSimulator.pdf')
else:
...
best_ranking_circuit.draw('mpl', filename='./circuitsQSVM/circuit_best_ranking_Diabetes_NoiseSimulator.pdf')
