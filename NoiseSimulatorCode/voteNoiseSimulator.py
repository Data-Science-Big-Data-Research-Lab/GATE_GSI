...
import pandas as pd
from GSI import calculate_GSI_MPS_parallel, create_feature_map, remove_low_M_gates, pegasusQSVCTrainNoiseSimulator, pegasusQSVCTest
import numpy as np
...
qc.decompose().draw('mpl', filename='./circuitsQSVM/circuit_base_Vote_NoiseSimulator.pdf')
...
best_accuracy_circuit.draw('mpl', filename='./circuitsQSVM/circuit_best_accuracy_Vote_NoiseSimulator.pdf')
...
if not candidates_time.empty:
    ...
    best_time_circuit.draw('mpl', filename='./circuitsQSVM/circuit_best_time_Vote_NoiseSimulator.pdf')
else:
...
best_ranking_circuit.draw('mpl', filename='./circuitsQSVM/circuit_best_ranking_Vote_NoiseSimulator.pdf')
