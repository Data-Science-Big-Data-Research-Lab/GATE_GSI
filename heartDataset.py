...
categorical_columns = ['ChestPainType', 'ExerciseAngina']
df_encoded = pd.get_dummies(df, columns=categorical_columns)

# Display dataset information
print(f"Dataset shape: {df.shape}")
print(f"Number of unique target labels: {df['HeartDisease'].nunique()}")

# Separate features (X) and target (y)
X = df_encoded.drop(['HeartDisease'], axis=1).astype(int)
...
qc.decompose().draw('mpl', filename='circuitsQSVM/circuit_base_heart.png')
print("Base circuit image saved as 'circuitsQSVM/circuit_base_heart.png'.")
...
results_df.to_csv('resultsHeartQSVM.csv')
print("\nResults saved to 'resultsHeartQSVM.csv'.")
...
best_accuracy_circuit.draw('mpl', filename='circuitsQSVM/circuit_best_accuracy_heart.png')
print("Best accuracy circuit image saved as 'circuitsQSVM/circuit_best_accuracy_heart.png'.")
...
if not candidates_time.empty:
    ...
    best_time_circuit.draw('mpl', filename='circuitsQSVM/circuit_best_time_heart.png')
    print("Best time circuit image saved as 'circuitsQSVM/circuit_best_time_heart.png'.")
else:
...
best_balanced_circuit.draw('mpl', filename='circuitsQSVM/circuit_best_ranking_heart.png')
print("Best ranking circuit image saved as 'circuitsQSVM/circuit_best_ranking_heart.png'.")
